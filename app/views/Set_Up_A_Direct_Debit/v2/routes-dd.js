...
router.post('/Set_Up_A_Direct_Debit/v2/submit_info', function (req, res) {
  ...
  // has been sent
  res.redirect('/Set_Up_A_Direct_Debit/v2/confirmation');

});


router.post('/Set_Up_A_Direct_Debit/v2/council_tax_number_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v2/same_address_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v2/address_check_check', function (req, res) {
