...
router.post('/Set_Up_A_Direct_Debit/v5/submit_info', function (req, res) {
  ...
  // has been sent
  res.redirect('/Set_Up_A_Direct_Debit/v5/confirmation');

});


router.post('/Set_Up_A_Direct_Debit/v5/council_tax_number_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v5/postcode_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v5/same_address_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v7/check_for_email_address', function (req, res) {
  ...
  if (req.session.data['emailAddress']) {
      ...
      res.redirect('communication_preferences_no_email');

    }

});

router.post('/Set_Up_A_Direct_Debit/v5/DD_date_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v5/address_check_check', function (req, res) {
