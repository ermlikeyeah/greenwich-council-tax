...
router.post('/Set_Up_A_Direct_Debit/v6/submit_info', function (req, res) {
  ...
  // has been sent
  res.redirect('/Set_Up_A_Direct_Debit/v6/confirmation');

});


router.post('/Set_Up_A_Direct_Debit/v6/property_confirmation', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v6/same_address_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v6/check_for_email_address', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v6/DD_date_check', function (req, res) {
...
router.post('/Set_Up_A_Direct_Debit/v6/existing_phone_number_answer', function (req, res) {

  if (req.session.data['queries-by-phone'] == 'yes' || req.session.data['queries-by-phone'] == ['post']) {
    res.redirect('same_address_question');
...
router.post('/Set_Up_A_Direct_Debit/v6/address_check_check', function (req, res) {
